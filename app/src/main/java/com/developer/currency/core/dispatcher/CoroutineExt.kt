package com.developer.currency.core.dispatcher
...
inline fun CoroutineScope.launchIO(
    ...
    val exceptionHandler = CoroutineExceptionHandler { _, throwable ->
        launch(errorDispatcher) { onError.invoke(throwable) }
    }
    return this.launch(exceptionHandler + Dispatchers.IO) { safeAction.invoke() }
}
...
inline fun CoroutineScope.launchMain(
    ...
    return this.launch(exceptionHandler + Dispatchers.Main) { safeAction.invoke() }
}
