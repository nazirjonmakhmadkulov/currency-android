...
import com.developer.valyutaapp.databinding.DialogItemBinding
...
class ValDialogAdapter(private val onItemValuteClick: (Valute) -> Unit) : ItemBase<DialogItemBinding, Valute> {
    ...
    override fun getViewHolder(layoutInflater: LayoutInflater, parent: ViewGroup): BaseViewHolder<DialogItemBinding, Valute> {
    ...
    inner class ValuteViewHolder(
        binding: DialogItemBinding, val onItemValuteClick: (Valute) -> Unit,
